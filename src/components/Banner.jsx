...
function Item(){
  const textStyle = {
    ...
    return(
        // <section className="flex w-[80%] justify-around my-10">
        //   <div className="flex flex-col gap-1 w-[50%]">
        //     <div><p>Lorem ipsum dolor sit amet consectetur adipisicing elit.<br/> Ipsum ducimus nesciunt doloremque quam officiis obcaecati<br/> omnis ipsa fugiat neque animi, delectus, nihil laborum<br/> hic corporis autem. Doloremque minima dolor at.</p></div>
        //     <div>Button</div>
        //   </div>
        //   <div>Image</div>
        // </section>
            ...
            <div className=" relative ">
                ...
                <div className="lg:max-w-xl lg:pr-5 relative z-40">
                    ...
                    <div className="mt-10 flex flex-col items-center md:flex-row">
                        <a href="/" className="mb-3 inline-flex h-12 w-full items-center justify-center bg-[#8c695c] px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-[#75584d] focus:outline-none md:mr-4 md:mb-0 md:w-auto">
                            View More</a>
                        <a href="/" aria-label="" className="group inline-flex items-center font-semibold text-g1">Order Now
