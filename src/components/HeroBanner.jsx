...
<div className="lg:block mt-24 hidden">
      <h2 className="text-5xl font-light tracking-wide text-g1" >
            <div className="font-bold tracking-wide" style={{fontFamily : '"Montserrat",sans-serif'}}><div className=" w-28 h-[2px] bg-black"></div>EXCLUSIVE COLLECTIONS</div> <br/> We Make you look
